import { ProfileContextType, ActionType, UserProfile } from "../common/typo";
import { updateProfiles } from "../components/profileContext";
...
export default function ProfileReducer(
  ...
  switch (type) {
    case "add": {
      ...
      const updatedState: ProfileContextType = {
    ...
    case "current": {
      if (state) {
        let updatedState: ProfileContextType = {
          ...state,
